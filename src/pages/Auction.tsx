...
// import { _SERVICE } from "../declarations/auction/auction.did";
// import { idlFactory } from "../declarations/auction";
...
//     let agent = await window.ic.plug.agent
//     console.log("Agent", agent);

//     const _auctionActor: ActorSubclass<_SERVICE> = Actor.createActor(
//       idlFactory,
//       {
//         agent,
//         canisterId: "fh3gm-mqaaa-aaaal-qc54q-cai",
//       }
//     );

//     // console.log("Auction Actor", _auctionActor);

//     // const auctions = await _auctionActor.getAllAuctions();
...
//     const auctions = await plugActor.getAllAuctions();
//     console.log("Auctions", auctions);
//   }
